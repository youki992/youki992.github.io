...
arl_url='https://45.32.30.231:5003/'
username='admin'
password='FTft2647'
time_sleep=3600# 秒为单位，获取资产
get_size=100   # 每次获取任务数，不用改
awvs_url='https://45.32.30.231:13443/'
key='1986ad8c0a5b3df4d7028d5f3c06e936c05b6b566d2484edda71b8c5ba199c53e'
...
webhook_url='https://api.telegram.org/bot5587515442:AAHzwCMJGyz-PO4OVi1Wy0KY0HNfEIC8ARQ/sendMessage?chat_id=-693673150'  #漏洞结果，企业微信漏洞通知key
...
def push_telegram(content):
    chat_id = '-693673150'
    token = '5587515442:AAHzwCMJGyz-PO4OVi1Wy0KY0HNfEIC8ARQ'
